...
public abstract class BlueRight extends LinearOpMode {
    ...
    public static double middleToBoardSpline1_y = -38;
    public static double middleToBoardSpline1_angle = 184;

    public static double middleToBoardSpline2_x = -42.5;   //maybe??
    public static double middleToBoardSpline2_y = -40;
    public static double middleToBoardSpline2_angle = 184;


    public static double leftSpikeReset_x = 34;
    public static double leftSpikeReset_y = -12;
    public static double leftSpikeReset_angle = 180;

    public static double leftToBoardSpline2_x = -41.2;
    public static double leftToBoardSpline2_y = -34.7;
    public static double leftToBoardSpline2_angle = 191;
    ...
    public static double rightToBoardSpline1_angle = 184;

    public static double rightToBoardSpline3_x = -41;
    public static double rightToBoardSpline3_y = -49;
    public static double rightToBoardSpline3_angle = 186;
    ...
    public void execute(PropDetection.TSEPosition position) {  //this is where you want to put the camera action code
        ...
        Trajectory leftSpikeReset = drive.trajectoryBuilder(spikeReset.end(), false)
