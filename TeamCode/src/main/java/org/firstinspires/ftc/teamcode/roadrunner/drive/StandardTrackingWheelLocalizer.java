...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 9.85; // in; distance between the left and right wheels //9.765 based on lateral tuner
    public static double FORWARD_OFFSET = -0.4; // in; offset of the lateral wheel
    public static double X_MULTIPLIER = 1.0059; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.005827072347187; // Multiplier in the Y direction
